...
export default function AdminDashboard() {
  ...
  const handleProductAdd = () => {
    navigate("/addProduct"); // Replace '/next-page' with the actual path you want to navigate to
  };
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-nowrap">
          <button
            className="bg-blue-500 w-48 h-16 text-white px-4 py-2 rounded-2xl hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 shadow-2xl"
